...
- **Lipids**: While they mostly survive the roast intact, they trap aromatic compounds and significantly affect the mouthfeel. Processing methods (washed, natural) alter the surface chemistry and lipid expression.`, b:"Polysaccharides, sucrose, chlorogenic acids, lipids, proteins, moisture — the raw material roasting acts on.",
...
3. **Drum Geometry**: How often the beans physically contact the hot metal.`, b:"Why you can't separate 'temperature' from 'time' from 'chemistry' — they're one coupled system.",
