    ...
    "topics": [
      {
        ...
        "content": "Roasting is fundamentally a thermodynamic process of forcing heat energy into a dense seed. This happens via three mechanisms:\n\n1. **[Conduction](https://en.wikipedia.org/wiki/Thermal_conduction)**: Direct physical contact. In a classic drum roaster, the steel drum absorbs heat from the burner. When the coffee beans physically touch the hot steel, heat is transferred directly into them.\n2. **[Convection](https://en.wikipedia.org/wiki/Convection)**: Heat transfer via a fluid (in this case, hot air). The burner heats the air, and the fan pulls this hot air through the tumbling bean mass. This is often the primary driver of roasting in modern machines.\n3. **[Radiation](https://en.wikipedia.org/wiki/Thermal_radiation)**: Heat transferred via electromagnetic waves (like feeling the heat of a fire on your skin). The hot metal of the roaster radiates energy into the beans without direct contact.\n\nDifferent roasters lean heavily on different methods. A classic Probat relies heavily on conduction (heavy cast iron), while a Loring relies almost entirely on convection (hot air fluid bed). Your roasting strategy must adapt to the machine's primary heat transfer method.",
        "points": [
    ...
    "topics": [
      {
        ...
        "content": "El tueste es fundamentalmente un proceso termodinámico de forzar energía térmica en una semilla densa. Esto ocurre mediante tres mecanismos:\n\n1. **[Conducción](https://es.wikipedia.org/wiki/Conducci%C3%B3n_t%C3%A9rmica)**: Contacto físico directo. En un tostador de tambor clásico, el acero absorbe calor del quemador. Cuando los granos tocan físicamente el acero caliente, el calor se transfiere directamente a ellos.\n2. **[Convección](https://es.wikipedia.org/wiki/Convecci%C3%B3n)**: Transferencia de calor a través de un fluido (aire caliente). El ventilador empuja aire caliente a través de la masa de granos. Este es a menudo el principal motor del tueste en máquinas modernas.\n3. **[Radiación](https://es.wikipedia.org/wiki/Radiaci%C3%B3n_t%C3%A9rmica)**: Calor transferido por ondas electromagnéticas. El metal caliente del tostador irradia energía a los granos sin contacto directo.\n\nLas diferentes máquinas se apoyan en distintos métodos. Una Probat clásica depende de la conducción (hierro fundido pesado), mientras que una Loring depende casi totalmente de la convección.",
        "points": [
