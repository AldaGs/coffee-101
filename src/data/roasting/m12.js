  ...
  "en": {
    ...
    "topics": [
      ...
      },
      {
        ...
        "content": "If you know you are tasting the 'expensive Geisha,' your brain will convince you it tastes better. If you know you are tasting the batch where you messed up the RoR curve, your brain will convince you it tastes baked.\n\nQuality control must be **Blind**. You must assign numbers to cups and hide the roast profiles.\n\n**[Triangulation](https://en.wikipedia.org/wiki/Triangle_test)** is a specific test: You place three cups on the table. Two are the exact same roast, and one is a slightly different roast. Your job is simply to identify the odd cup out. This proves whether a minor change you made to the roasting curve actually made a perceivable difference in the cup, or if you are just chasing ghosts on a graph.",
        "points": [
